...
foreach ($suite in @('isolation.harness.ps1','renderer-injection.harness.ps1','herdr-lifecycle.harness.ps1','cleanup-receipt.tests.ps1','bootstrap-integrity.tests.ps1','path-boundaries.harness.ps1','operation-callers.tests.ps1','operation-engine.tests.ps1','registry-outcome.tests.ps1')) {
