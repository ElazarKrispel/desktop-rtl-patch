...
# pinned to the v2.0.4 tag and is the same code as the ZIP download.
...
# NOTE: the asset name carries the BARE version (Build-Release.ps1 -Version 2.0.4
# produces desktop-rtl-patch-2.0.4.zip), while the tag has the 'v' prefix.
