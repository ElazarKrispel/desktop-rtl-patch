...
# Get-RtlHebrewError now lives in scripts\lib\desktop-rtl-errors.ps1 (dot-sourced by the
# lib above), so the GUI, tray and settings all share one implementation.
