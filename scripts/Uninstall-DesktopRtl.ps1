<#
.SYNOPSIS
    Remove the Desktop RTL patch for the selected app (-App codex|opencode|traycer|t3code|grokbot): the
...
#>
[CmdletBinding()]
param([ValidateSet('codex','opencode','traycer','t3code','grokbot')][string]$App = 'codex', [switch]$PurgeLogs)
